...
class Widget:
    ...
    def __init__(self, parent:"Layout" = None, tag_name:str = "", widget_class_list:List[str] = [], widget_id:str = None, widget_attributes:dict = {}, auto_attach:bool = False):
    ...
    def parent(self, new_parent:"Layout"):
        # parent_id = "null" if self.parent is None else f'"{self.parent.id}"'
        # self.api.app_window.evaluate_js(f'window.hufpy.$detatchWidget("{self.id}", {parent_id});')
        # self.api.app_window.evaluate_js(f'window.hufpy.$attachWidget("{self.id}", "{new_parent.id}", "{self.widget_type}");')
    ...
    def has_style_property(self, name:str):
...
class Layout(Widget):
    ...
    def __init__(self, parent:Union["Layout", webview.Window] = None, tag_name:str = "", widget_class_list:List[str] = None, widget_id:str = None, widget_attributes:dict = {}, auto_attach:bool = False):
